...
#ifdef BLLIB_EXPORTS
#define BLLIB_API __declspec(dllexport)
#else
#define BLLIB_API __declspec(dllimport)
#endif

#define EXTEND_CFG_BASE (0xDFFFF000)
#define MODE_CFG_BASE (EXTEND_CFG_BASE)
#define MODE_CFG_SIZE (4)
#define UART_CFG_BASE (EXTEND_CFG_BASE+MODE_CFG_SIZE)
#define UART_CFG_SIZE (8)

#define MODE_ON_LINE (0)
#define MODE_OFF_LINE (1)
#define MCUCOM_STC (0)
#define MCUCOM_UART (1)

typedef struct EXTEND_CFG
{
	BYTE MODE_DLmode;
	BYTE MODE_MCUcom;
	BYTE MODE_reserved1;
	BYTE MODE_reserved2;
    long UART_speedInBaud;
	BYTE UART_nbBit;
	BYTE UART_parity;
	BYTE UART_nbStopBit;
	BYTE UART_reserved1;
...
/*
/************************************************************************************/
BLLIB_API BYTE SetPaketSize(BYTE WORD);
