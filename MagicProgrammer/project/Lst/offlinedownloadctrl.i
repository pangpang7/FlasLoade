#line 1 "..\\source\\OfflineDownloadCtrl.c"
#line 1 "..\\include\\hw_config.h"
...
#line 22 "..\\include\\hw_config.h"
#line 1 "..\\include\\platform_config.h"
...
#line 22 "..\\include\\platform_config.h"
...
#line 23 "..\\include\\hw_config.h"

 
 
 
static __inline void SO_SetBits(u16 Signal)
{ 
	((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0C00))->BSRR = Signal;
	__nop();
	__nop();
	__nop();
	__nop();
...
static __inline void SO_ResetBits(u16 Signal)
{
	((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0C00))->BRR = Signal;
	__nop();
	__nop();
	__nop();
	__nop();
...
static __inline void SO_WriteBits(u16 Signal, BitAction BitVal)
{
	if (BitVal != Bit_RESET)
	{
	  ((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0C00))->BSRR = Signal;
...
static __inline u8 SI_GetBits(u16 Signal)
{
  if ((((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0C00))->IDR & Signal) != (u32)Bit_RESET)
  {
    return (u8)Bit_SET;
  }
  else
...
#line 2 "..\\source\\OfflineDownloadCtrl.c"
#line 1 "..\\include\\OfflineDownloadCtrl.h"
...
#line 5 "..\\include\\OfflineDownloadCtrl.h"

#line 12 "..\\include\\OfflineDownloadCtrl.h"
...
#line 3 "..\\source\\OfflineDownloadCtrl.c"
#line 4 "..\\source\\OfflineDownloadCtrl.c"
#line 1 "..\\include\\BLSlave.h"
...
typedef enum  {TYPE_STC=0x00,TYPE_UART=0x01} COM_TYPE;
...
#line 5 "..\\source\\OfflineDownloadCtrl.c"
...
#line 7 "..\\source\\OfflineDownloadCtrl.c"
#line 1 "..\\source\\STC.h"
#line 4 "..\\source\\STC.h"
...
void STC_Test(void);
#line 8 "..\\source\\OfflineDownloadCtrl.c"
#line 1 "..\\source\\SI6600.h"





#line 18 "..\\source\\SI6600.h"
...
#line 30 "..\\source\\SI6600.h"




#line 9 "..\\source\\OfflineDownloadCtrl.c"
#line 1 "..\\source\\UART.h"
#line 4 "..\\source\\UART.h"
...
#line 10 "..\\source\\OfflineDownloadCtrl.c"
...
void EarseAndResetAll(void)
{
	...
	FLASH_Earse(((0x8040000-(48*0x800))-(1*0x800)),((0x8040000-(48*0x800))-(1*0x800))+sizeof(mcu_scfg)-1);
	FLASH_Program(((0x8040000-(48*0x800))-(1*0x800)),(u8 *)&mcu_scfg,sizeof(mcu_scfg));
}

void OfflineInit(void)
{
	
	pmcu_cfg=(const MCU_CFG*)((0x8040000-(48*0x800))-(1*0x800));
	if((checksum((u8 *)pmcu_cfg,sizeof(MCU_CFG)))||(pmcu_cfg->flag != 0x55))
	{
		EarseAndResetAll();
	}
	else
...
{ 
	if((done!=mcu_scfg.ram_done))
	{
		...
		if(!mcu_scfg.ram_done)
			OfflineEarseMCURAM();
		if(!FLASH_Earse(((0x8040000-(48*0x800))-(1*0x800)),((0x8040000-(48*0x800))-(1*0x800))+sizeof(mcu_scfg)-1))
			return FALSE;
		if(!FLASH_Program(((0x8040000-(48*0x800))-(1*0x800)),(u8 *)&mcu_scfg,sizeof(mcu_scfg)))
			return FALSE;	
	}
	return TRUE;	
}
...
bool SetPwd(u8* data)
{
	memcpy(&mcu_scfg.max_auth_num,data,((1)+(1)+(16)+(32)+(16)+(1))-(1));
	mcu_scfg.pwdflag=0x55;
	mcu_scfg.checksum=checksum((u8 *)&mcu_scfg,sizeof(MCU_CFG)-1);
	if(!FLASH_Earse(((0x8040000-(48*0x800))-(1*0x800)),((0x8040000-(48*0x800))-(1*0x800))+sizeof(mcu_scfg)-1))
		return FALSE;
	if(!FLASH_Program(((0x8040000-(48*0x800))-(1*0x800)),(u8 *)&mcu_scfg,sizeof(mcu_scfg)))
...
bool AuthPwd(u8* pwd)
{
	...
	for(i=0;i<16;i++)
	{
		...
		{
			if(mcu_scfg.max_auth_num!=0xFF)
				mcu_scfg.max_auth_num--;
			if(mcu_scfg.max_auth_num!=0)
			{
				mcu_scfg.checksum=checksum((u8 *)&mcu_scfg,sizeof(MCU_CFG)-1);
				if(!FLASH_Earse(((0x8040000-(48*0x800))-(1*0x800)),((0x8040000-(48*0x800))-(1*0x800))+sizeof(mcu_scfg)-1))
					return FALSE;
...
bool OfflineEarseMCURAM(void)
{
	memset(mcu_scfg.ram_map,0,48);
	return FLASH_Earse((0x8040000-(48*0x800)),(0x8040000-(48*0x800))+(48*0x800)-1);
}

bool OfflineEarseMCUFLASH(void)
{
	memset(mcu_scfg.flash_map,0,128);
	return FLASH_Earse(0x8040000,0x8040000+(48*0x800)-1);	
}
...
bool OfflineProgramMCURAM(u32 StartAddr,u8 * data, u32 lg)
{
	...
	if(mcu_scfg.ram_done)
		return FALSE;
	if(((ReAddr<(0x8040000-(48*0x800)))||(ReAddr>=(0x8040000-(48*0x800))+(48*0x800)))
		||((ReAddr+lg-1<(0x8040000-(48*0x800)))||(ReAddr+lg-1>=(0x8040000-(48*0x800))+(48*0x800))))
		return FALSE;
	if(!FLASH_Program(ReAddr,data,lg))
		return FALSE;
	mcu_scfg.ram_map[(ReAddr-(0x8040000-(48*0x800)))/0x800]=TRUE;
	mcu_scfg.ram_map[(ReAddr+lg-(0x8040000-(48*0x800)))/0x800]=TRUE;
	return TRUE;
}
...
bool OfflineProgramMCUFLASH(u32 StartAddr,u8 * data, u32 lg)
{
	...
	if(mcu_scfg.flash_done)
		return FALSE;
	if(((ReAddr<0x8040000)||(ReAddr>=0x8040000+(128*0x800)))
		||((ReAddr+lg-1<0x8040000)||(ReAddr+lg-1>=0x8040000+(128*0x800))))
		return FALSE;
	if(!FLASH_Program(ReAddr,data,lg))
		return FALSE;
	mcu_scfg.flash_map[(ReAddr-0x8040000)/0x800]=TRUE;
	mcu_scfg.flash_map[(ReAddr+lg-0x8040000)/0x800]=TRUE;
	return TRUE;
}
...
bool OfflineDownloadwithUART(void)
{
	...
	if(mcu_scfg.pwdflag==0x55)
	{
		if(!UART_WritePWD(&mcu_scfg.max_auth_num))
			return FALSE;
	}
	else
	{
	...
	for(i=0;i<128;i++)
	{
		...
		{
			for(j=0;j<0x800/1024;j++)
			{
				if(!UART_Write(0x8040000+i*0x800+j*1024+mcu_scfg.flash_offset, 
						1024, 
						(u8*)(0x8040000+i*0x800+j*1024), 
						TRUE))
					return FALSE;	
			}
		}
	...
	for(i=0;i<128;i++)
	{
		if(mcu_scfg.flash_map[i])
		{
			for(j=0;j<0x800/1024;j++)
			{
				if(!UART_Read(0x8040000+i*0x800+j*1024+mcu_scfg.flash_offset, 
						1024, 
						RD_Buffer, 
						TRUE))
					return FALSE;
				if(memcmp(RD_Buffer,(u8*)(0x8040000+i*0x800+j*1024),1024)!=0)
					return FALSE;	
			}
		}
	}
...
bool OfflineDownloadwithSTC(void)
{
	...
	for(i=0;i<128;i++)
	{
		if(mcu_scfg.flash_map[i])
		{
			...
			tmpcfg.addr=0x8040000+i*0x800+mcu_scfg.flash_offset;
			tmpcfg.data=(u8*)(0x8040000+i*0x800);
			tmpcfg.cnt=0x800;
			STC_Write(&tmpcfg);
		}
	}
	...
	for(i=0;i<128;i++)
	{
		if(mcu_scfg.flash_map[i])
		{
			...
			if(memcmp(RD_Buffer,(u8*)(0x8040000+i*0x800),0x800)!=0)
				return FALSE;
		}
	}
...
bool OfflineDownload(void)
{
	if(mcu_scfg.com_type==0)
		return OfflineDownloadwithSTC();
	else if(mcu_scfg.com_type==1)
		return OfflineDownloadwithUART();
	else
		return FALSE;
}
