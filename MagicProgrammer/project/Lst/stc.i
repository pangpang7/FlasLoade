...
void SPIPassword_WriteCmd(void);
void SPIPassword_Write(void);
void SPIPassword_Write_ArrayITX(void);
void SPIPassword_Read_ArrayITX(void);
...
u16 controlcnt[16];
u8  MassOrInfo;
extern u8 ArrayITX[33];
extern u8 ArrayIRX[32];
...
{
	u16 i;
	SO_ResetBits(((u16)0x1000));
	SO_ResetBits(((u16)0x8000));
	SO_ResetBits(((u16)0x2000));
	for(i=0;i<200;i++)
	{
		SO_SetBits(((u16)0x2000));
		SO_ResetBits(((u16)0x2000));

	}

	SO_SetBits(((u16)0x8000));
	for(i=0;i<250;i++)
	{
		SO_SetBits(((u16)0x2000));
		SO_ResetBits(((u16)0x2000));
...
{  	
	...
	control[3]=0x259; controlcnt[3]=2810;
	control[4]=0x251; controlcnt[4]=20;
...
void STC_MassEraseCmdAll(void)						 
{
	...
	control[3]=0x2d9; controlcnt[3]=2810;
	control[4]=0x2d1; controlcnt[4]=20;
...
void STC_PageErase(void)						 
{
	...
	if(DwordCfg.MainOrInfo)
	{
		...
		control[3]=0x249; controlcnt[3]=2810;
		control[4]=0x241; controlcnt[4]=20;
	...
	else
	{
		...
		control[3]=0x2c9; controlcnt[3]=2810;
		control[4]=0x2c1; controlcnt[4]=20;
...
void STC_OP(u8 Symbol,u32 addr,u32 dataa,u8 count)
{
	...
	for(i=0; i<3; i++)		  
	{
		SO_WriteBits(((u16)0x8000),(BitAction)ArrayITX[i]);
		SO_SetBits(((u16)0x2000));
		SO_ResetBits(((u16)0x2000));
	}
	...
	for(i=0; i<16; i++)		 
	{	
		SO_WriteBits(((u16)0x8000),(BitAction)ArrayITX[i+3]);
		SO_SetBits(((u16)0x2000));
		SO_ResetBits(((u16)0x2000));
	}
	...
	for(i=0; i<32; i++)
	{	
		SO_WriteBits(((u16)0x8000),(BitAction)ArrayITX[i+19]);
		SO_SetBits(((u16)0x2000));
		SO_ResetBits(((u16)0x2000));
	}
	...
	for(k=0;k<count;k++)			   
	{
		...
		{
			 temp_data = k*10;
			 SO_WriteBits(((u16)0x8000),(BitAction)STCcontrol[temp_data]);
			 SO_SetBits(((u16)0x2000));
			 SO_ResetBits(((u16)0x2000));
			 SO_WriteBits(((u16)0x8000),(BitAction)STCcontrol[temp_data+1]);
			 SO_SetBits(((u16)0x2000));
			 SO_ResetBits(((u16)0x2000));
			 SO_WriteBits(((u16)0x8000),(BitAction)STCcontrol[temp_data+2]);
			 SO_SetBits(((u16)0x2000));
			 SO_ResetBits(((u16)0x2000));
			 SO_WriteBits(((u16)0x8000),(BitAction)STCcontrol[temp_data+3]);
			 SO_SetBits(((u16)0x2000));
			 SO_ResetBits(((u16)0x2000));
			 SO_WriteBits(((u16)0x8000),(BitAction)STCcontrol[temp_data+4]);
			 SO_SetBits(((u16)0x2000));
			 SO_ResetBits(((u16)0x2000));
			 SO_WriteBits(((u16)0x8000),(BitAction)STCcontrol[temp_data+5]);
			 SO_SetBits(((u16)0x2000));
			 SO_ResetBits(((u16)0x2000));
			 SO_WriteBits(((u16)0x8000),(BitAction)STCcontrol[temp_data+6]);
			 SO_SetBits(((u16)0x2000));
			 SO_ResetBits(((u16)0x2000));
			 SO_WriteBits(((u16)0x8000),(BitAction)STCcontrol[temp_data+7]);
			 SO_SetBits(((u16)0x2000));
			 SO_ResetBits(((u16)0x2000));
			 SO_WriteBits(((u16)0x8000),(BitAction)STCcontrol[temp_data+8]);
			 SO_SetBits(((u16)0x2000));
			 SO_ResetBits(((u16)0x2000));
			 ...
			 SO_WriteBits(((u16)0x8000),(BitAction)STCcontrol[temp_data+9]);
			 SO_SetBits(((u16)0x2000));
			 SO_ResetBits(((u16)0x2000));			
		}
	}	 
...
void STC_Write_DWORD(void)
{
	...
	for(i=0; i<3; i++)		  
	{
		SO_WriteBits(((u16)0x8000),(BitAction)ArrayITX[cnt_ArrayITX++]);
		SO_SetBits(((u16)0x2000));
		SO_ResetBits(((u16)0x2000));
	}
...
void STC_Read_DWORD(void)
{
	...
	{
		SO_SetBits(((u16)0x8000));
		ArrayITX[i]=SI_GetBits(((u16)0x4000));  
		SO_SetBits(((u16)0x2000));
		SO_ResetBits(((u16)0x2000));
	}
...
void STC_Write(LPSTC_CONFIG pcfg)
{
	...
	if(pcfg->MainOrInfo)
	{
		...
		control[4]=0x263; controlcnt[4]=3;
	...
	else
	{
		...
		control[4]=0x2e3; controlcnt[4]=3;
...
void STC_PWDPageEarse()
{
	u32 tmp[2];
	STC_CONFIG tmpcfg;
	
	DwordCfg.MainOrInfo=FALSE;
	DwordCfg.addr=(0x400>>2);
	STC_PageErase();
...
void STC_WritePWD(u8* data)
{
	...
	if(!memcmpfixed(&data[49],0xFF,16))
	{
		STC_GetChipID(&data[49]);
	}
	
	tmpcfg.MainOrInfo=FALSE;
	tmpcfg.addr=((0x400)+(1));
	tmpcfg.data=data;
	tmpcfg.cnt=((1)+(1)+(16)+(32)+(16)+(1))-(1);
	STC_Write(&tmpcfg);
...
bool STC_AUTHPWD(u8* pwd)
{
	...
	tmpcfg.MainOrInfo=FALSE;
	tmpcfg.addr=(((0x400)+(1))+(1));
	tmpcfg.data=tmp;
	tmpcfg.cnt=(16);
	STC_Read(&tmpcfg);
	
	if(memcmp(tmp,pwd,(16))!=0)
	{
...
void STC_Test(void)
{
	...
	for(j=0;j<64;j++)
	{
		for(i=0;i<1024;i++)
		{
			if(j==0x29)test_wr[i]=0x21;
			else if(j==0)test_wr[i]=0x49;
			else test_wr[i]=j;
		}
		tmpcfg.MainOrInfo=TRUE;
