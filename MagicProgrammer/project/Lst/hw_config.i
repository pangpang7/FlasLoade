...
#line 21 "..\\source\\hw_config.c"
#line 1 "..\\include\\usb_desc.h"
...
extern const u8 CustomHID_ReportDescriptor[37];
extern const u8 CustomHID_StringLangID[4];
extern const u8 CustomHID_StringVendor[38];
extern const u8 CustomHID_StringProduct[32];
extern u8 CustomHID_StringSerial[26];



 
#line 22 "..\\source\\hw_config.c"
...
void Set_System(void)
{
  ...
  RCC_APB2PeriphClockCmd( ((u32)0x00000004)
...
void USB_Interrupts_Config(void)
{
  ...
  NVIC_SetVectorTable(((u32)0x08000000), 0x00);
  ...
  NVIC_InitStructure.NVIC_IRQChannel = ((u8)0x0A);
  NVIC_InitStructure.NVIC_IRQChannelPreemptionPriority = 1;
...
void GPIO_Configuration(void)
{
  ...
  RCC_APB2PeriphClockCmd(((u32)0x00000008) | ((u32)0x00000040) | ((u32)0x00000004) | ((u32)0x00000010)
                         , ENABLE);   
...
void EXTI_Configuration(void)
{
  ...
  GPIO_EXTILineConfig(((u8)0x04), ((u8)0x04));
  
     
  EXTI_InitStructure.EXTI_Line = ((u32)0x00010);
...
u32 UART_send(u32 lg,u8* data)
{
	...
	while(i<lg)
	{
	   	...
	   	USART_SendData(((USART_TypeDef *) (((u32)0x40000000) + 0x4400)), data[i]);
	
		  
	    while(USART_GetFlagStatus(((USART_TypeDef *) (((u32)0x40000000) + 0x4400)), ((u16)0x0040)) == RESET)
	    {
...
u32 UART_rev(u32 lg,u8* data)
{
	...
	while(i<lg)
	{
    	...
    	while(USART_GetFlagStatus(((USART_TypeDef *) (((u32)0x40000000) + 0x4400)), ((u16)0x0020)) == RESET)
    	{
			if(SysTime-tmptime>3300)
				return i;
    	}

		data[i++] = USART_ReceiveData(((USART_TypeDef *) (((u32)0x40000000) + 0x4400)))&0xff;
	}
	return i;
}
...
void HappyLight(void)
{
  ...
  {
  	if(!((SysTime-1)&0x1FF))
		GPIO_WriteBit(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0C00)), ((u16)0x0020),((SysTime-1)>>9)&0x01);
  }
  else if(HappyMode==3)
  {
  	if(!((SysTime-1)&0x3F))
		GPIO_WriteBit(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0C00)), ((u16)0x0020),((SysTime-1)>>6)&0x01);
  }
}
...
void SetHappyLight(u32 mode)
{
  ...
  if(HappyMode==1)
  {
  	 HappyFlag=TRUE;
	 tmptime=GetSysTick();
  	 GPIO_ResetBits(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0C00)), ((u16)0x0020));
	 while(GetSysTick()-tmptime<1000);
  	 GPIO_SetBits(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0C00)), ((u16)0x0020));
  }
}
...
bool FLASH_Earse(u32 StartAddr,u32 EndAddr)
{
  ...
  NbrOfPage = (EndAddr - StartAddr) / 0x800 + 1;

   
  FLASH_ClearFlag(((u32)0x00000001) | ((u32)0x00000020) | ((u32)0x00000004) | ((u32)0x00000010));	

   
  for(EraseCounter = 0; (EraseCounter < NbrOfPage) && (FLASHStatus == FLASH_COMPLETE); EraseCounter++)
  {
    FLASHStatus = FLASH_ErasePage(StartAddr + (0x800 * EraseCounter));
