...
#line 19 "..\\source\\usb_prop.c"
#line 20 "..\\source\\usb_prop.c"
...
ONE_DESCRIPTOR String_Descriptor[4] =
  {
    ...
    {(u8*)CustomHID_StringVendor, 38},
    {(u8*)CustomHID_StringProduct, 32},
...
void CustomHID_Reset(void)
{
  ...
  SetEPRxAddr(((u8)1), (0x104));
  SetEPTxCount(((u8)1), 0x40);
  SetEPRxCount(((u8)1), 0x40);
...
void CustomHID_SetConfiguration(void)
{
  if (pInformation->Current_Configuration != 0)
  {
    ...
    ADC_SoftwareStartConvCmd(((ADC_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x2400)), ENABLE);
  }
}
