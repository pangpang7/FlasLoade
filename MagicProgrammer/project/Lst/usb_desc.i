...
const u8 CustomHID_ConfigDescriptor[41] =
  ...
  ;  
const u8 CustomHID_ReportDescriptor[37] =
  {    
    0x05, 0x01,                    
    0x09, 0x00,                    
    0xa1, 0x01,                    
...
const u8 CustomHID_StringVendor[38] =
  {
    38,  
    0x03,   
...
const u8 CustomHID_StringProduct[32] =
  {
    32,           
    0x03,         
    'S', 0, 'I', 0, 'P', 0, 'R', 0, 'O', 0, 'G', 0, 'R', 0,
    'A', 0, 'M', 0, 'M', 0, 'E', 0, 'R', 0, ' ', 0, 'X', 0,
    '1', 0
  };
