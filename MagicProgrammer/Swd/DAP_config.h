...
// SWCLK Pin                 
#define PORT_SWCLK           
#define PIN_SWCLK_IN_BIT	 			
#define PIN_SWCLK            

// SWDIO Pin                  
#define PORT_SWDIO            
#define PIN_SWDIO_IN_BIT	  	
#define PIN_SWDIO             

// nRESET Pin                 
#define PORT_nRESET           
#define PIN_nRESET_IN_BIT	  
#define PIN_nRESET            
*/
...
#define X_SET(str)    PORT_##str->BSRR = PIN_##str
#define X_CLR(str)    PORT_##str->BRR = PIN_##str 
//#define X_DIR_OUT(str) GPIOE->CRH=(GPIOE->CRH)&(~(0xf<<8))|(3<<8)
//#define X_DIR_IN(str)  GPIOE->CRH=(GPIOE->CRH)&(~(0xf<<8))|(4<<8)
//#define X_DIR_OUT(str) PORT_##str->CRH=(PORT_##str->CRH)&(~(0xf<<((PIN_##str##_IN_BIT-8)*4)))|(3<<((PIN_##str##_IN_BIT-8)*4))
//#define X_DIR_IN(str)  PORT_##str->CRH=(PORT_##str->CRH)&(~(0xf<<((PIN_##str##_IN_BIT-8)*4)))|(4<<((PIN_##str##_IN_BIT-8)*4))
#define X_DIR_OUT(str) 
#define X_DIR_IN(str) 
#define X_BYTE(str)  (PORT_##str->IDR & PIN_##str)?1:0   
